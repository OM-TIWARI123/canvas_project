...
import { Shirt, Palette, Store, ShoppingBag } from '@repo/ui/lib/icons';
...
const features = [
  {
    ...
    description:
      'Create unique designs with our intuitive 2D canvas editor for your apparel',
  },
  {
    icon: Store,
    title: 'Shopify Integration',
    description:
      'Seamlessly connect your Shopify store and publish products directly',
  },
  {
    icon: ShoppingBag,
    title: 'Automatic Orders',
    description:
      'Orders from your store are automatically routed for fulfillment',
  },
  {
    icon: Shirt,
    title: 'Premium Quality',
    description: 'High-quality apparel crafted to your specifications',
  },
];
